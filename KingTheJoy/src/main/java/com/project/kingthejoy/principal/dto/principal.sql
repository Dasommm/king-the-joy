...
SELECT * FROM CLASS WHERE MEMBER_SEQ = 4
UPDATE CLASS SET CLASS_NAME = '장미반' WHERE MEMBER_SEQ = 4

SELECT COUNT(*) FROM CLASS WHERE MEMBER_SEQ = 4
...
INSERT INTO CLASS(CLASS_SEQ, CLASS_NAME, CHILDREN_SEQ, MEMBER_SEQ, SCHOOL_SEQ)
	VALUES(CLASS_SEQ.NEXTVAL, '미정', 0, 3, 1 )
>>>>>>> gallery
