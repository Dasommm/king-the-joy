							...
							<form>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<c:choose>
											<c:when
												test="${sessionScope.memberDto.getMember_role() eq 0}">
												<input class="form-control" type="text" name="member_rodle"
													value="관리자" readonly>
											</c:when>
											<c:when
												test="${sessionScope.memberDto.getMember_role() eq 1}">
												<input class="form-control" type="text" name="member_rodle"
													value="원장님" readonly>
											</c:when>
											<c:when
												test="${sessionScope.memberDto.getMember_role() eq 2}">
												<input class="form-control" type="text" name="member_rodle"
													value="선생님" readonly>
											</c:when>
											<c:when
												test="${sessionScope.memberDto.getMember_role() eq 3}">
												<input class="form-control" type="text" name="member_rodle"
													value="학부모" readonly>
											</c:when>
										</c:choose>
		...
		<div class="modal" id="myModal">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<!-- Modal body -->
					<div class="modal-body">유치원 정보 들어갈 곳</div>

					<!-- Modal footer -->
					<div class="modal-footer">

						<button type="button" class="btn btn-danger" data-dismiss="modal">유치원
							정보 수정</button>
