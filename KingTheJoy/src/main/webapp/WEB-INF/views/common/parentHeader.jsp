...
<body>
	<nav>
		...
		<a class="logo" href="roleCheck.do"> <img
			src="./resources/img/kinderJoyLogo.png">
		</a>

		<div class="MyMenu">
			<a href="myPage.do" class="mymenu-link">마이페이지</a> <a href="logout.do"
				class="mymenu-link">로그아웃</a>
		</div>
	...
	<!-- 요청사항 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>-->		
			<li class="menu_li">
				<div class="menu-css" id="req">
					...
					<ul class="request">
						<li><a class="menu-link" href="/translate/translate.do">번역</a></li>
						<li><a class="menu-link" href="/pill/pillrequest.do">투약 요청서</a></li>
					</ul>
				</div>
			</li>
