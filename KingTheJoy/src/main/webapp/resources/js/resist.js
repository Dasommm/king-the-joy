					...
					$('form').on(
							...
							function() {
								...
								if (mailJ.test($('#member_email').val())) {
									console.log(mailJ.test($('#member_email')
											.val()));
									inval_Arr[3] = true;
								} else {
									inval_Arr[3] = false;
								...
								if (phoneJ.test($('#member_phone').val())) {
									console.log(phoneJ.test($('#member_phone')
											.val()));
									inval_Arr[4] = true;
								} else {
									inval_Arr[4] = false;
...
function execPostCode() {
	new daum.Postcode({
		oncomplete : function(data) {
			...
			document.getElementById('member_oaddr').value = data.zonecode; // 5자리
																			// 새우편번호
																			// 사용
